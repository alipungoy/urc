...
var CurrentUrl= document.URL;
            ...
            $( ".navbar-nav li a" ).each(function() {
                  ...
                  $(this).closest('#collapseTwo').addClass('show')
                  $(this).closest('#collapsePages').addClass('show')
                  $(this).closest('#collapseThree').addClass('show')
                  $(this).closest('#collapseSettings').addClass('show')
                  }
            });
